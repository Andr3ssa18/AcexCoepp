...
# Variáveis globais para app e mail
app = None
flask_mail = None

def init_app(flask_app, mail):
    """Inicializa o módulo views com as instâncias do Flask e Mail"""
    global app, flask_mail
    app = flask_app
    flask_mail = mail
    create_views(app, mail)

def create_views(app, flask_mail):
